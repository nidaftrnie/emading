...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="index.php"> Kelola Artikel / </a></span> Tambah
        Artikel</h4>
                    ...
                    <form action="action_process.php?action=add" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="mb-3">
                                    <label for="uploadFoto" class="form-label">Gambar*</label>
                                    <input type="file" name="foto" class="form-control" id="exampleFormControlInput1"
                                        placeholder="Masukan Gambar Artkel" required />
